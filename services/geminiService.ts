...
export class GeminiService {
  async generateStrategy(data: BusinessData): Promise<GrowthStrategy> {
    ...
    const prompt = `
      ...
      5. ROADMAP: For each task in the roadmap, you MUST provide a "whyItMatters" field explaining how this specific task impacts the business goals or targets.
      ...
      REQUIRED JSON SCHEMA:
      {
        ...
        "roadmap": [{"day": number, "phase": 1, "title": "string", "description": "string", "goal": "string", "creativeFocus": "string", "whyItMatters": "string"}],
        "adSocialStrategy": {
